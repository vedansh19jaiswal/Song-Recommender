...
def getTrackFeatures(id):
    ...
    artist = track_info['album']['artists']['name']
    emotion = track_info['emotion'][0]['album']['artists']['name']
    

    track_data = [name, album, artist] #, release_date, length, popularity
    return track_data

# for creating dataframe of feteched playlist
...
for i in range(len(track_ids)):
    ...
    df = pd.DataFrame(track_list, columns = ['Name','Album','Artist','Emotion']) # ,'Release_date','Length','Popularity'
