import numpy as np
import cv2 #reading
from PIL import Image #image processing capability
...
emotion_model = Sequential() #creating layer by layer
...
cv2.ocl.setUseOpenCL(False)#accelerating functioning
...
class VideoCamera(object):
	...
	def get_frame(self):
		...
		df1 = df1[['Name','Album','Artist','Emotion']]
		df1 = df1.head(15)
...
def music_rec():
	...
	df = df[['Name','Album','Artist','Emotion']]
	df = df.head(15)
	return df
